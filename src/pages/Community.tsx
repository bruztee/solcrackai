...
import { Calendar, Github, MessageSquare, Users } from 'lucide-react';
...
const Community = () => {
  ...
  const communityChannels = [
    {
      name: "X",
      description: "Join our X to stay tuned and get recent news.",
  ...
  return (
    <section className="pt-32 pb-20 relative min-h-screen">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div id={SECTION_IDS.contribute} className="bg-gray-900/50 backdrop-blur-sm border border-red-900/20 rounded-2xl p-8">
          <div className="text-center mb-8">
